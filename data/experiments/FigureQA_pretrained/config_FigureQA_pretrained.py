...
lut_location = ''  # When training, LUT for transcript and answer token to idx is computed from scratch if left empty, or
...
if image_encoder == 'dense':
    ...
    densenet_dim = [128, 160, 352]  # TODO: Computer according to config
